...
module ActionText::RichText::EmbedsAttachmentsAssociationExtension
  # source://activestorage/7.0.4/lib/active_storage/attached/model.rb#165
  def purge; end

  # source://activestorage/7.0.4/lib/active_storage/attached/model.rb#171
  def purge_later; end

  private

  # source://activestorage/7.0.4/lib/active_storage/attached/model.rb#178
  def deprecate(action); end
end

module ActionText::RichText::GeneratedAssociationMethods
  # source://activestorage/7.0.4/lib/active_storage/attached/model.rb#134
  def embeds; end

  # source://activestorage/7.0.4/lib/active_storage/attached/model.rb#139
