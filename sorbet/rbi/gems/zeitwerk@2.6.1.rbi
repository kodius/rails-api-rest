...
module Zeitwerk
  class << self
    ...
    #
    # source://zeitwerk//lib/zeitwerk.rb#19
    def with_loader; end
  end
end
...
class Zeitwerk::Loader
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#39
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#29
  def autoloads; end
  ...
  # `force: true`.
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#218
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#73
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#81
  def mutex2; end
  ...
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#202
  def reload; end

  # Sets autoloads in the root namespace.
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#101
  def setup; end
  ...
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#275
  ...
  # source://zeitwerk//lib/zeitwerk/loader.rb#397
  ...
  #
  # source://zeitwerk//lib/zeitwerk/loader.rb#421
  ...
  # source://zeitwerk//lib/zeitwerk/loader.rb#432
  def set_autoload(parent, cname, abspath); end

  # source://zeitwerk//lib/zeitwerk/loader.rb#333
  def set_autoloads_in_dir(dir, parent); end

  # source://zeitwerk//lib/zeitwerk/loader.rb#498
  def unload_autoload(parent, cname); end

  # source://zeitwerk//lib/zeitwerk/loader.rb#504
  ...
  class << self
    ...
    #
    # source://zeitwerk//lib/zeitwerk/loader.rb#325
    def all_dirs; end

    # Returns the value of attribute default_logger.
    #
    # source://zeitwerk//lib/zeitwerk/loader.rb#292
    ...
    #
    # source://zeitwerk//lib/zeitwerk/loader.rb#317
...
module Zeitwerk::Loader::Config
  ...
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#200
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#52
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#45
  ...
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#148
  def dirs(namespaces: T.unsafe(nil)); end

  # Let eager load ignore the given files or directories. The constants defined
  # in those files are still autoloadable.
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#182
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#58
  ...
  # @raise [Zeitwerk::Error]
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#161
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#31
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#39
  ...
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#24
  def inflector; end
  ...
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#272
  def log!; end

  # Returns the value of attribute logger.
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#81
  def logger; end
  ...
  # @raise [TypeError]
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#236
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#71
  def on_load_callbacks; end

  # Configure a block to be called after setup and on each reload.
  # If setup was already done, the block runs immediately.
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#212
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#64
  ...
  # @raise [TypeError]
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#261
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#78
  ...
  # @raise [Zeitwerk::Error]
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#108
  ...
  # @private
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#21
  def root_dirs; end
  ...
  # writer below.
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#129
  def tag; end
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#304
  def collapse?(dir); end

  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#299
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/config.rb#294
...
module Zeitwerk::Loader::Helpers
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/helpers.rb#120
  def cdef?(parent, cname); end

  # @raise [NameError]
  #
  # source://zeitwerk//lib/zeitwerk/loader/helpers.rb#126
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/helpers.rb#68
  def dir?(path); end

  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/helpers.rb#46
  def has_at_least_one_ruby_file?(dir); end

  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/helpers.rb#73
  ...
  # @return [Boolean]
  #
  # source://zeitwerk//lib/zeitwerk/loader/helpers.rb#63
  def ruby?(path); end

  # source://zeitwerk//lib/zeitwerk/loader/helpers.rb#101
  def strict_autoload_path(parent, cname); end
end

# source://zeitwerk//lib/zeitwerk/loader.rb#16
